...
const fullName = document.getElementById('e-full-name');
const organization = document.getElementById('e-organization');
const phone = document.getElementById('e-phone');
const email = document.getElementById('e-email');
const zipCode = document.getElementById('e-postal-code');
const country = document.getElementById('e-country');
const paymentMethod = document.getElementById('col2');
const submitForm = document.getElementsByTagName('form')[0];

let testedRadioButtons = [];
