...
<head>
    ...
    <link rel="stylesheet" href="stands-schema.css">
    <title>Stand Virtuelle</title>
</head>

<body>

    <h2 class="standpage-heading">Choose Your Stand in The Schema Below</h2>
    ...
    <script src="stands-schema.js"></script>
</body>
